...
export interface ElementsFeatureVariant extends Schema.Component {
  collectionName: 'components_elements_feature_variants';
  info: {
    displayName: 'Feature variant';
    description: '';
  };
  attributes: {
    ...
    variant: Attribute.Enumeration<['comipems', 'superior']> &
      Attribute.Required;
  };
}
...
export interface SectionsFeaturesSwich extends Schema.Component {
  collectionName: 'components_sections_features_swiches';
  info: {
    displayName: 'Features swich';
    description: '';
  };
  attributes: {
    heading: Attribute.String;
    description: Attribute.String;
    feature: Attribute.Component<'elements.feature-variant', true>;
  };
}
...
export interface SectionsHero extends Schema.Component {
  ...
  attributes: {
    ...
    picture: Attribute.Media & Attribute.Required;
    buttons: Attribute.Component<'links.button-link', true>;
    isBackGround: Attribute.Boolean & Attribute.DefaultTo<false>;
    ligthUrl: Attribute.String;
    darkurl: Attribute.String;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'elements.feature-variant': ElementsFeatureVariant;
      ...
      'sections.features-swich': SectionsFeaturesSwich;
