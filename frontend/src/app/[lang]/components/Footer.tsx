...
import { CgWebsite, CgInstagram, CgFacebook } from "react-icons/cg";
            ...
            {socialLinks.map((link: FooterLink) => {
              return (
                <a
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-yellow-400 dark:text-gray-900"
                >
