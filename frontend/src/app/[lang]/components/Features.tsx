      ...
      {showLink && url && text && (
        <div>
          <Link
            ...
            className="inline-block px-4 py-2 mt-4 text-sm font-semibold text-white transition duration-200 ease-in-out bg-yellow-500 rounded-lg hover:bg-yellow-600"
          >
            {text}
          </Link>
        </div>
